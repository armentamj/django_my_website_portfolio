"""
Django settings for armentamj project.
...
from dotenv import load_dotenv # So Django knows to read the .env file

load_dotenv() # Actualy loading the .env file
...
ALLOWED_HOSTS = ['www.armentamj.de', 'www.armentamj.de:8000', 'localhost', '127.0.0.1']
